...
const employeeVrPresetByTeam: Record<string, { valorDia: number; valorSabado: number }> = {
  "LFO-BRUNO J": { valorDia: 32.63, valorSabado: 45 },
  "CFO-FABIO": { valorDia: 32.63, valorSabado: 45 },
  "BFO- ELTON": { valorDia: 32.63, valorSabado: 45 },
  "DCF VIVO": { valorDia: 32.63, valorSabado: 45 },
