  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Ayronex" />
        <link rel="manifest" href="/manifest.json" />
        <link rel="apple-touch-icon" href="/icon-192.png" />
      </head>
      <body suppressHydrationWarning>
        <Script id="ayronex-theme-bootstrap" strategy="beforeInteractive">{`
          (function () {
            try {
              var key = 'ayronex-theme-v1';
        ...
        `}</Script>
        <Script id="ayronex-pwa-register" strategy="afterInteractive">{`
